...
**Live Demo:** [https://huggingface.co/spaces/arnold2309/HIRO_SOCIAL_GOVERNANCE](https://huggingface.co/spaces/arnold2309/HIRO_SOCIAL_GOVERNANCE)
...
- **API Keys:**
  - `Nvdia_API_KEY`: For LLM inference.
